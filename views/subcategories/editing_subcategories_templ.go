...
func EditingSubcategories(subcategories []models.Subcategory, category string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(subcategories) == 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/subcategories/editing_subcategories.templ`, Line: 14, Col: 56}
			}
			...
			for _, subcategory := range subcategories {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/subcategories/editing_subcategories.templ`, Line: 20, Col: 57}
				}
